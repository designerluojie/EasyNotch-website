// Directly reused from React Bits Star Border.
// Source: https://github.com/DavidHDev/react-bits/tree/main/src/ts-default/Animations/StarBorder
...
const StarBorder = <T extends React.ElementType = "button">({
  ...
  return (
    <Component
      ...
      style={{ padding: `${thickness}px 0`, ...(rest as React.ComponentPropsWithoutRef<T>).style }}
    >
